		...
		<div id="container-wrap">
			<div id="container-ariticle-add">
				<div id="content-article-add">
					<h2>编辑经历</h2><br/>
					<form name = "articleForm" method="post" action="__URL__/experienceEdit?id=<?php echo ($exp["id"]); ?>">
						<span class="headline">标题：</span><input name="title" class="essay-title" type="text" value="<?php echo ($exp["title"]); ?>"/><br/>
						<span class="headline">行业：</span>
<select name="industry">
	<option value="internet">IT/互联网/通信/电子</option>
	<option value="finance">金融/投资/财会</option>
	<option value="ad">广告/媒体/出版/艺术</option>
	<option value="market">市场/销售/客服</option>
	<option value="hr">人事/行政/管理</option>
	<option value="building">建筑/房产/物业</option>
	<option value="consumergoods">消费品/贸易/物业</option>
	<option value="consult">咨询/法律/认证</option>
	<option value="product">生产/制造/营运/采购</option>
	<option value="biology">生物/制药/医疗/护理</option>
	<option value="education">教育/培训/翻译</option>
	<option value="research">科研/环保/休闲/其他</option>
	
</select><br/>
						<span class="headline">经历摘要：</span>
						<div ><textarea id="essay-abstract" name="summary"><?php echo ($exp["summary"]); ?></textarea></div>
						<span class="headline">经历正文：</span>
						<textarea id="essay-content" name="content" style="width:100%; height:700px;"><?php echo ($exp["content"]); ?></textarea>
...
为职场人士、在校学生等用户群提供了一个记录和分享自己职业生涯、了解各行业职位、规划职业生涯、为求职做相关准备的平台。
							...
							<div class="inner-block">
								...
								<div class="footer-content">
									...
									<a class="pic-link-small" href="__APP__/Profile?member=poryzhao"><img title="poryzhao" src="__ROOT__/Home/Uploads/poryzhao_large.png" onerror="this.src='__TMPL__/resource/images/person-default-large.png'" /></a>
									...
									<a class="pic-link-small" href="__APP__/Profile?member=水情曦鱼"><img title="水情曦鱼" src="__ROOT__/Home/Uploads/水情曦鱼_large.png" onerror="this.src='__TMPL__/resource/images/person-default-large.png'" /></a>
									<a class="pic-link-small" href="__APP__/Profile?member=tinker"><img title="tinker" src="__ROOT__/Home/Uploads/tinker_large.png" onerror="this.src='__TMPL__/resource/images/person-default-large.png'" /></a>
