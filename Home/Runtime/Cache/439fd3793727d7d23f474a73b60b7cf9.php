...
<link rel="stylesheet" type="text/css" href="__PUBLIC__/Css/page.css" / >
	...
	<link rel="stylesheet" href="__TMPL__/resource/css/members.css"/>
	<div id="container-wrap">
		<div id="members">
		
			<?php if(is_array($members)): foreach($members as $key=>$member): ?><div class="member">
					<a href="__APP__/Profile?member=<?php echo ($member["username"]); ?>"><img alt="������ң��ϴ�ͷ��Ŷ~" onerror="this.src='__TMPL__/resource/images/person-default-large.png'"  src="__ROOT__/Home/Uploads/<?php echo ($member["username"]); ?>_large.png"/></a>
					<div class="person-meta">
						<div class="name"><?php echo ($member["username"]); ?></div>
						<div class="email"><?php echo ($member["email"]); ?></div>
						<div class="school"><?php echo ($member["school"]); ?></div>
						<div class="motto"><?php echo ($member["motto"]); ?></div>
					
					</div>
				</div><?php endforeach; endif; ?>
				<div class="member">
					<a href="__APP__/Register"><img src="__TMPL__/resource/images/join_us.jpg"/></a>
				</div>
			<br class="clear"/>
		</div>
	</div>
