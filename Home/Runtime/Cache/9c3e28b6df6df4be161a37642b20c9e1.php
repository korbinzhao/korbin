		...
		<div id="container-wrap">
			<div id="container-ariticle-add">
				<div id="content-article-add">
					<h2>添加作品</h2><br/>
					<form name = "articleForm" method="post" action="__URL__/workAdd" enctype="multipart/form-data">
						...
						<div ><textarea id="essay-abstract" name="summary" style="width:100%;height:100px;"></textarea></div><br/>
						<span class="headline">作品链接：</span>&nbsp;&nbsp;
						<input name="attachment" class="essay-title" type="text" /><br/>
