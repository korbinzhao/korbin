		...
		<div id="container-wrap">
			<div id="container-ariticle-add">
				<div id="content-article-add">
					<h2>添加经历</h2><br/>
					<form name = "articleForm" method="post" action="__URL__/experienceAdd">
						<span class="headline">标题：</span><input name="title" class="essay-title" type="text"/><br/>
...
<select name="industry">
	...
	<option value="research">科研/环保/休闲/其他</option>
						...
						<div ><textarea id="essay-abstract" name="summary"></textarea></div>
						<span class="headline">经历正文：</span>
						<textarea id="essay-content" name="content" style="width:100%; height:700px;"></textarea>
