		...
		<div id="container-wrap">
			<div id="container-ariticle-add">
				<div id="content-article-add">
					<h2>添加岗位</h2><br/>
					<form name = "articleForm" method="post" action="__APP__/PostAdd/postAdd">
						<span class="headline">岗位名称：</span>
						<input name="postname" class="essay-title" type="text"  value="<?php echo ($postname); ?>"/><br/>
...
<select name="industry">
	...
	<option value="research">科研/环保/休闲/其他</option>
						...
						<span class="headline">职位简介：</span>
						<textarea  id="introduction" name="introduction" style="width:100%;height:300px;"></textarea>
						<span class="headline">职位需求：</span>
						<textarea  id="requirement" name="requirement" style="width:100%; height:300px;"></textarea>
						<span class="headline">个人提升：</span>
						<textarea id="improvement"  name="improvement" style="width:100%;height:300px;"></textarea>
						<span class="headline">招聘信息：</span>
						<textarea id="employment"  name="employment" style="width:100%; height:300px;"></textarea>
